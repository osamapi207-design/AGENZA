...
<?php elseif ($tab === 'api'): ?>
<div class="note">المزود: <b><?= e(AmerAI::label()) ?></b> • الحرارة: <?= e((string)AmerConfig::temperature()) ?> • حد الرسائل: <?= e((string)AmerConfig::ratePerMin()) ?>/دقيقة • المفتاح: <?= AmerAI::keyPresent() ? '<span class="ok">موجود ✔</span>' : '<span class="bad">ناقص — ضعه في Environment Variables</span>' ?></div>
<a class="btn" style="text-decoration:none" href="?tab=api&ping=1">🔌 اختبار الاتصال</a><br><br>
<?php if ($apiStatus): ?>
